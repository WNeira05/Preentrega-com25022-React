...
const Cart = ({ isOpen, onClose, borrarProducto }) => {
    ...
    const calcularTotal = () => {
        const total = itemsAgrupados.reduce((total, item) => total + (item.precio * item.cantidad), 0);
        return total.toLocaleString('es-AR', { style: 'currency', currency: 'ARS', minimumFractionDigits: 2 });
    };
                                    ...
                                    <li key={item.id} className='cart-item-detail'>
                                        <div className='item-info'>
                                            ...
                                            <div className='item-details'>
                                                ...
                                                <span>Precio: {item.precio.toLocaleString('es-AR', {
                                                    style: 'currency',
                                                    currency: 'ARS',
                                                    minimumFractionDigits: 2
                                                })}</span>
